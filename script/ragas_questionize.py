...
if __name__ == "__main__":
    ...
    # create Documents
    documents = [ Document(page_content=txt, metadata={"source": "local"})     for txt in chunks]
    ...
    output_file = f"./data/question_answers_{docs_concatenate}_{datetime.datetime.now().strftime('%Y%m%d%H%M')}.jsonl"
